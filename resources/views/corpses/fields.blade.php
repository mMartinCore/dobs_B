    ...
    @endsection
     ...
     <span class="confirm">
            <div class="well" style="background: ">
              ...
              <button type="submit"  class=" postForm btn btn-lg btn-primary  small-box-footer btn-md" id="postForm" data-loading-text=" <i class='fa fa-spinner fa-spin'></i> Please wait.."> Save <i class="fa fa-arrow-circle-right"></i></button>
