...
<style>
    ...
    <section class="content-header">
        <h1>
                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>  Edit   Corpse
        </h1>
        <br>
   </section>
...
<div class="form-group col-sm-3">
        ...
        <select name="condition" class="form-control condition" onchange="CorpseCondition()" id="condition">
            <option value="{{$corpse->condition}}">{{$corpse->condition}}</option>
            <option value="">Select an Option</option>
...
<div class="form-group col-sm-3">
    ...
    <select name="manner_death" class="form-control manner_death"  onchange="mannerDeath()" id="manner_death">
        <option value="{{$corpse->manner_death}}">{{$corpse->manner_death}}</option>
        <option value="">Select an Option</option>
...
<div class="form-group col-sm-3">
    {!! Form::label('anatomy', 'Anatomy:') !!}<small id="Error_anatomy"></small>
     <select name="anatomy" class="form-control anatomy" onchange="anotomMethod()" id="anatomy">
        <option value="{{$corpse->anatomy}}">{{$corpse->anatomy}}</option>
        <option value="">Select an Option</option>
        ...
        <option value="Burnt Remains">Burnt Remains</option>
        <option value="Amputated">Amputated</option>
        <option value="Torso">Torso</option>
        <option value="Decapitated">Decapitated</option>
...
{{--
            <!-- Regnum Field -->
            <div class="form-group col-sm-3">
                  {!! Form::label('regNum', 'Regnum:') !!}<small id="Error_regNum"></small>
                  {!! Form::number('regNum', $corpse->regNum, ['class' => ' regNum form-control']) !!}
              </div>
             ...
             <div class="form-group  col-sm-3 {{$errors->has('rank_id') ? 'has-error' :''}}">
                          ...
                          <select name="rank_id" value="{{Request::old('rank_id')}}" onchange="investigatorRank()" class=" rank_id form-control" >
                            <option value="{{$corpse->rank_id}}">{{$corpse->rank}}</option>
          ...
          <div class="form-group col-sm-3">
                  ...
                  {!! Form::text('investigator_first_name', $corpse->investigator_first_name, ['class' => ' investigator_first_name form-control']) !!}
              </div>

              <!-- Investigator Last Name Field -->
              <div class="form-group col-sm-3">
                  {!! Form::label('investigator_last_name', 'I.O Last Name:') !!} <small id="Error_investigator_last_name"></small>
                  {!! Form::text('investigator_last_name', $corpse->investigator_last_name, ['class' => 'investigator_last_name form-control']) !!}
              </div>
              ...
              <div class="form-group col-sm-3">
                  ...
                  {!! Form::date('assign_date', $corpse->assign_date, ['class' => 'form-control assign_date','id'=>'assign_date']) !!}
              </div>
              ...
              <input type="text" name="contact_no" value="{{$corpse->contact_no}}" id="contact_no" class="contact_no form-control" placeholder="xxx-xxx-xxxx" >
              </div>
            ...
            <div class="form-group  col-sm-6 {{$errors->has('station_id') ? 'has-error' :''}}">
                      ...
                      <select name="station_id" value="{{Request::old('station_id')}}" onchange="investigator_stn()" class=" station_id form-control" >
                        <option value="{{$corpse->station_id}}">{{$corpse->station->station}}</option>
                        <option value="">Select a Station</option>
                            @foreach($stations as $station)
                                <option value='{{ $station->id }}'>{{ $station->station}}</option>
                            @endforeach
            ...
            <div class="styl">
                ...
                <div class="container col-sm-offset-2">
                        ...
                        <div class="form-group col-sm-12">
                                ...
                                <button type="submit"  class=" editForm editUpdate btn btn-lg btn-primary  small-box-footer btn-md" id="editForm" data-loading-text=" <i class='fa fa-spinner fa-spin'></i> Please wait.."> Update <i class="fa fa-arrow-circle-right"></i></button>
          ...
          if (r == true) {
            $('#postEdit')[0].reset();
              ...
              if($(".investigator_first_name").val() !=''&&  $(".investigator_last_name").val() !='')
                {
                  alert("Your dction did not Commit!");
                }
